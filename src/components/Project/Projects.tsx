...
export default function Project() {
  const projects = [
    {
      title: "LinkShare",
      description: "Plataforma innovadora para compartir y organizar enlaces profesionales. Incluye análisis de datos y personalización avanzada para optimizar la gestión de recursos digitales.",
    ...
    {
      title: "CloudSync",
      description: "Solución empresarial de sincronización en la nube con características de seguridad avanzada y colaboración en tiempo real para equipos distribuidos.",
